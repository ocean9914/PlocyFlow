...
{
    public class AllNClosedController : BaseController
    {
        //
        // GET: /AllNClosed/
        ...
        public ActionResult Index()
        {
            ...
            if (!PagePurview.verifyVisble(uid, "AllNClosed/Index"))
            {
                return Redirect("~/Error/Accessdeny");
            }
            Initial("All过往查询", "个人工作台 > ALL未关闭查询");
            setInitialData();
            return View();
        }
        ...
        {
            Initial("All过往查询", "个人工作台 > ALL未关闭 查询");
        ...
        private void setInitialData()
        {
            ...
            ViewData["dataSouce"] = MyWorkedList.GetAllNClosed(deptId, productId, startD, endD);
        }
        private void DownFile()
        {
            var dsouce = MyWorkedList.GetAllNClosed(deptId, productId, startD, endD);
            if (dsouce != null)
            {
