                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 70%; text-align: left;">
                               <%using (Html.BeginForm("AddDeptName", "BaseMain", FormMethod.Post, new { style = "display:inline-block;" }))
                                 {  %>
                                  <span class="micblack ml_10">部门ID</span>
                                 <%=Html.TextBox("idTxt","",new {@class="micblack ml_5 bd t_r",style="width:60px;"})%>&nbsp
                                <span class="micblack ml_10">部门名称</span>
                        ...
                        <tr>
                            ...
                            <td style="width: 70%;  vertical-align: top; padding-left: 10px;" >
                                <table id="dataTable" class="mt_10" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% int rowIndex = 0;
                                           var data = ViewData["dataSouce"] as List<dept>;
                                        ...
                                        <tr style="background-color: #F7F6F3; color: #333333; height: 20px;">
                                            ...
                                            <td>
                                                <%=Html.ActionLink("删除","delDept",new{id=tr.id}) %>
                                            </td>
                                        </tr>
                                        <% }
                                           } %>
