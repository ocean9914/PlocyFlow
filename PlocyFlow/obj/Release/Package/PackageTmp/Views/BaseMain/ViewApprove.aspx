                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 70%; text-align: left;">
                               <%using (Html.BeginForm("AddApproveName", "BaseMain", FormMethod.Post, new { style = "display:inline-block;" }))
                                 {  %>
                                <span class="micblack ml_10">审批级别</span>
                        ...
                        <tr>
                            ...
                            <td style="width: 70%;  vertical-align: top; padding-left: 10px;" >
                                <table id="dataTable" class="mt_10" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% int rowIndex = 0;
                                           var data = ViewData["dataSouce"] as List<approve_type>;
                                        ...
                                        <tr style="background-color: #F7F6F3; color: #333333; height: 20px;">
                                            ...
                                            <td>
                                                <%=Html.ActionLink("删除","delApprove",new{id=tr.id}) %>
                                            </td>
                                        </tr>
                                        <% }
                                           } %>
