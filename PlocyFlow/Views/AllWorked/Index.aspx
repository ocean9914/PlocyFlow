    ...
    <center>
        <div class="percent_100 t_l ml_3">
            <div class="percent_100 lf" style="width: 760px;">
                <%using (Html.BeginForm("seek", "AllWorked", FormMethod.Post, new { style = "display:inline-block;", autocomplete = "off" }))
                  { %>
        ...
        <%using (Html.BeginForm("setView", "AllWorked", FormMethod.Post, new { style = "display:none;" }))
          {  %>
