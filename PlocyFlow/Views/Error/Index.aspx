...
<div style="text-align: center;">
        <div style="margin: 50px auto; width: 500px; text-align: left;">
            <img style="float: left; margin-right: 20px;" src="<%=Url.Content("~/Content/images/icon-error.gif")%>" alt=""/>
            <div style="padding: 10px 0 100px;">
                <span style="font-weight: bold; color: #f00; font-size: 14px;">对不起，您当前访问的页面发生错误，请联系管理员！</span><br />
                <p>
