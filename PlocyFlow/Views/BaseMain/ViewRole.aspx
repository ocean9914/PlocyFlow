                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 70%; text-align: left;">
                                <%using (Html.BeginForm("AddRoleName", "BaseMain", FormMethod.Post, new { style = "display:inline-block;" }))
                                 {  %>
                                <span class="micblack ml_10">角色名称</span>
                        ...
                        <tr>
                            ...
                            <td style="width: 70%;  vertical-align: top; padding-left: 10px;" >
                                <table id="dataTable" class="mt_10" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% int rowIndex = 0;
                                           var data = ViewData["dataSouce"] as List<role>;
                                        ...
                                        <tr style="background-color: #F7F6F3; color: #333333; height: 20px;">
                                            ...
                                            <td>
                                                <%=Html.ActionLink("删除","delRole",new{id=tr.id}) %>
                                            </td>
                                        </tr>
                                        <% }
                                           } %>
